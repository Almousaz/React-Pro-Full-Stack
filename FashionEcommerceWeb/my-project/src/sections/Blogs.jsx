...
const Blogs = () => {
  ...
  return (
    ...
    <section id='blogs' className={`${ darkMode ? 'dark lg-[#19191a]' : 'light bg-slate-200'} w-full lg:px-20 px-10 lg:py-20 py-10 flex flex-col justify-center items-center gap-6 `}>
        <h1 data-aos='zoom-in' className='text-2xl text-slate-500 dark:text-white text-center '>LATEST POSTS</h1>
            ...
            <Slider {...settings } >
                {
                    blogs.map((item , index) => (
                        <div key={index} id='product-box' className=' flex flex-col justify-center items-start gap-1 bg-white rounded-lg dark:bg-black'>
