  ...
  return (
    <>
      <section
        ...
        } w-full lg:px-20 px-10 lg:py-20 py-8 lg:h-screen h-fit
        dark:bg-slate-700 dark:bg-transparent flex flex-col lg:flex-row justify-between
        items-center bg-cover bg-center gap-10`}
      >
        <div className=" flex flex-col justify-center items-start gap-6 lg:w-[60%] w-full">
          ...
          >
            Effortless <br></br> glamour for <br />
            every occassions
          </h1>
          <button
            data-aos="zoom-in"
