      ...
      >
        ...
        >
          <img
            ...
            src={siteLogo}
            alt="site logo"
            className=" lg:w-[400px] lg:h-[100px] dark:filter dark:invert"
          />
          <div
            data-aos="zoom-in"
            id="header-icons"
            className=" lg:flex hidden justify-center items-center gap-8 absolute top-20 right-0 dark:text-white"
          >
